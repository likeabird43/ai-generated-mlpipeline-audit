> An AI-generated workflow, when implemented with a flawed evaluation setup,
...
This project does not demonstrate a failure of models,
but a **failure mode of workflows**.
...
Without careful auditing, such workflows can lead to conclusions
that appear meaningful but do not generalize.
